...
public class CartActivity extends AppCompatActivity implements CartActivityView {
    ...
    public void onCostUpdate(double totalItemCost) {
        ...
        binding.tvSheppingCost.setText(String.format(Locale.ENGLISH, "%.2f %s", 25.0, country.equals("em") ? getString(R.string.aed) : getString(R.string.tl)));
        binding.tvTotal.setText(String.format(Locale.ENGLISH, "%.2f %s", totalItemCost+25.0, country.equals("em") ? getString(R.string.aed) : getString(R.string.tl)));
